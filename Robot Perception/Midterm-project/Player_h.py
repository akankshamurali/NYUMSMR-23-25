...
class KeyboardPlayer(Player):
    ...
    def find_matching_image(self,img):
        ...
        try:
            ...
            closest_index = self.find_closest_match(target_features)
                ...
                if image_number is not None:
                    ...
                    try:
                        ...
                        if matching_image is not None:
                            ...
                            # start_point = (150, 265)
                            # end_point = (30,24) # TBD Based on indexing code
                            # maze_img=cv2.imread('maze_solver\\maze.jpg',cv2.IMREAD_GRAYSCALE)
                            # maze_solver_obj = maze_solver(src=start_point, dst=end_point, img=maze_img)
    ...
    def show_target_images(self):
        ...
        if self.goal is None:
            self.find_matching_image(targets[0])
